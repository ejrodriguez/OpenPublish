...
class NavbarPresenter extends Presenter {
	...
	{
		return  PHP_EOL . '<ul class="nav main-menu">' . PHP_EOL;
	}
	...
	{
		// $item->getUrl() para poner la ruta en href
		return '<li'.$this->getActiveState($item).'><a href="'.'#'.'" ' . $item->getAttributes() .'>'.$item->getIcon().' '.$item->title.'</a></li>' . PHP_EOL;
	}
