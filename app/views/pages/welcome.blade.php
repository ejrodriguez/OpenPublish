...
$(document).on('click', '#information',function (e) {
	...
	$.ajax({
	    ...
	    .done(function() {
	    	$("#jscontent").load('{{URL::route('showinformacion')}}');
...
$(document).on('click', '#momento',function (e) {
	e.preventDefault();
	
	$.ajax({
	    	
	    	url: "{{URL::route('showinmomento')}}",
	    	type: 'GET',
	    	beforeSend: function(){
	    ...
	    .done(function() {
	    	$("#jscontent").load('{{URL::route('showinmomento')}}');
